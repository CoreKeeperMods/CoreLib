...
namespace CoreLib.Components
{
    public class EntityPrefabOverride : ModCDAuthoringBase
    {
        ...
        public override bool Apply(MonoBehaviour data)
        {
            ...
            {
                Logger.LogInfo($"Overriding prefab for {monoData.ObjectInfo.objectID.ToString()} to {entityId.ToString()} prefab!");
            ...
            {
                Logger.LogInfo($"Overriding prefab for {objectAuthoring.objectID.ToString()} to {entityId.ToString()} prefab!");
