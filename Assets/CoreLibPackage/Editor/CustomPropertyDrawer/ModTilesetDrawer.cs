...
namespace CoreLib.Editor
{
    ...
    public class ModTilesetDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            string tilesetValue = property.stringValue;
            ...
            string newValue = EditorGUI.TextField(stringRect, label, tilesetValue);
            int newIndex = EditorGUI.Popup(dropdownRect, " ", _selectedIndex, _allModTilesets);
