...
namespace CoreLib.Submodules.ModEntity
{
    ...
    public class EntityModule : BaseSubmodule
    {
        ...
        /// <summary>
        /// Represents the specific build version of the module, defined using a <c>GameVersion</c> object.
        /// This property provides detailed versioning information such as release, major, minor versions,
        /// and an associated build hash string for identifying exact versions.
        /// </summary>
        internal override GameVersion Build => new GameVersion(1, 1, 0, "ab78");

        /// <summary>
        /// Represents the version of the module, providing semantic versioning information.
        /// This can be used to identify the specific iteration or release of a module.
        /// </summary>
        internal override string Version => "4.0.10";
        ...
        /// <summary>
        /// A dictionary that maps `Type` objects to `Action<MonoBehaviour>` delegates for modifying prefabs.
        ...
        /// <summary>
        /// Applies all modification authorings to the targeted GameObjects in the mod authoring list.
