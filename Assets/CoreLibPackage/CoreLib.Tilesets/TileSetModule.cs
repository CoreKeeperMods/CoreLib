...
namespace CoreLib.TileSets
{
    ...
    public class TileSetModule : BaseSubmodule
    {
        ...
        /// <summary>
        /// Represents the build information of the <c>TileSetModule</c>.
        /// </summary>
        /// <remarks>
        /// The <c>Build</c> property specifies the current build version and hash of the <c>TileSetModule</c>.
        /// This information is utilized to track specific builds for debugging, testing, or deployment purposes
        /// within the CoreLib framework, ensuring proper versioning and compatibility across various modules.
        /// </remarks>
        internal override GameVersion Build => new GameVersion(1, 1, 0, "90bc");

        /// <summary>
        /// Represents the version of the <c>TileSetModule</c>.
        /// </summary>
        /// <remarks>
        /// The <c>Version</c> property specifies the current version number of the <c>TileSetModule</c>.
        /// It is used to indicate the implemented version of the module, which can be helpful for
        /// compatibility checks, debugging, and configuration purposes when working with various
        /// modules in the CoreLib framework.
        /// </remarks>
