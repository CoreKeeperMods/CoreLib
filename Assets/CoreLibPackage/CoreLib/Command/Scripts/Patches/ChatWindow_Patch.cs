...
namespace CoreLib.Submodule.Command.Patches
{
    internal class ChatWindowPatch
    {
        ...
        public static void OnUpdate(ChatWindow __instance)
        {
            ...
            if (CommandsModule.RewiredPlayer.GetButtonDown(CommandsModule.UpKey))
            {
                CurrentHistoryIndex--;
            ...
            if (CommandsModule.RewiredPlayer.GetButtonDown(CommandsModule.DownKey))
            {
                CurrentHistoryIndex++;
            ...
            if (CommandsModule.RewiredPlayer.GetButtonDown(CommandsModule.CompleteKey))
            {
