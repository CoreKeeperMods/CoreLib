...
using CoreLib.Submodule.Command.Handlers;
using CoreLib.Submodule.Command.Patches;
using CoreLib.Submodule.RewiredExtension;
...
namespace CoreLib.Submodule.Command
{
    ...
    public class CommandsModule : BaseSubmodule
    {
        ...
        public new const string Name = "Core Lib Command";
        ...
        public static void AddCommands(long modId, string modName)
        {
            ...
            var commands = API.Reflection.GetTypes(modId)
                .Where(type => typeof(IServerCommandHandler).IsAssignableFrom(type) ||
                                                                           typeof(IClientCommandHandler).IsAssignableFrom(type)).ToArray();
        ...
        internal override void Load()
        {
            ...
            if (mod == null)
            {
                Log.LogError("Failed to find CoreLib.Commands mod info!");
        ...
        internal override void PostLoad()
        {
            ...
            RewiredExtensionModule.AddKeybind(UpKey, "Next command", KeyboardKeyCode.UpArrow);
            RewiredExtensionModule.AddKeybind(DownKey, "Previous command", KeyboardKeyCode.DownArrow);
            RewiredExtensionModule.AddKeybind(CompleteKey, "Autocomplete command", KeyboardKeyCode.Tab);
            
            RewiredExtensionModule.AddKeybind(ToggleQuantumConsole, "Toggle Quantum console", KeyboardKeyCode.Delete);
