...
namespace CoreLib.Submodule.TileSets.Components
{
    /// <summary>
    ...
    public class ModPseudoTileAuthoring : MonoBehaviour
    {
        ...
        /// This property is decorated with the <see cref="CoreLib.Util.Atributes.ModTilesetAttribute"/>
        ...
        /// component and is utilized in tile type conversion and association processes.
