...
using System.Linq;
using CoreLib.Submodule.LootDrop.Patches;
using PugMod;
...
namespace CoreLib.Submodule.LootDrop
{
    public class DropTablesModule : BaseSubmodule
    {
        ...
        public const string ID = "CoreLibLootDrop";
        public new const string Name = "Core Lib Loot Drop";
        
        /// <summary>
        /// Provides a singleton instance of the <see cref="DropTablesModule"/> class.
        ...
        /// within the <see cref="DropTablesModule"/>. Each entry contains the unique loot table identifier as the key
        ...
        /// <summary>
        /// Represents the last assigned custom loot table ID within the <see cref="DropTablesModule"/> class.
