...
namespace CoreLib.UserInterface
{
    ...
    public class UserInterfaceModule : BaseSubmodule
    {
        ...
        /// <summary>
        /// Represents the specific version of the game associated with the <see cref="UserInterfaceModule"/>.
        /// This property provides information about the release, major, minor version, and build hash
        /// for tracking and compatibility purposes.
        /// </summary>
        internal override GameVersion Build => new GameVersion(1, 1, 0, "90bc");

        /// <summary>
        /// Represents the version of the submodule implementation. This property provides
        /// a string indicating the specific version of the submodule, typically used for
        /// versioning and compatibility checks within the CoreLib framework.
        /// </summary>
